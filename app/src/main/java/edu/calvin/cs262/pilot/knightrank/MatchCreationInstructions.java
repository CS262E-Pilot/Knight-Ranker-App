...
/**
 * Class MatchCreationInstructions defines a Fragment that provides the user with technical
 * instructions on how to create a competition match within the Knight-Ranker Application.
 */
public class MatchCreationInstructions extends Fragment {
    ...
    private static final String LOG_TAG =
            MatchCreationInstructions.class.getSimpleName();
    ...
    public MatchCreationInstructions() {
     ...
     * @return A new instance of fragment MatchCreationInstructions.
     */
    // TODO: Rename and change types and number of parameters
    public static MatchCreationInstructions newInstance(String param1, String param2) {
        MatchCreationInstructions fragment = new MatchCreationInstructions();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_match_creation_instructions, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout thisLayout = Objects.requireNonNull(getView()).findViewById(R.id.fragment_match_creation_instructions_root_layout);

...
/**
 * Class AccountLoginInstructions defines a Fragment that provides the user with technical
 * instructions on how to log into the Knight-Ranker Application via a Google Account.
 */
public class AccountLoginInstructions extends Fragment {
    ...
    private static final String LOG_TAG =
            AccountLoginInstructions.class.getSimpleName();
    ...
    public AccountLoginInstructions() {
     ...
     * @return A new instance of fragment AccountLoginInstructions.
     */
    // TODO: Rename and change types and number of parameters
    public static AccountLoginInstructions newInstance(String param1, String param2) {
        AccountLoginInstructions fragment = new AccountLoginInstructions();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_account_login_instructions, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RelativeLayout thisLayout = Objects.requireNonNull(getView()).findViewById(R.id.fragment_account_login_instructions_root_layout);

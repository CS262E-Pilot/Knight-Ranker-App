...
public class MatchGETLoader extends AsyncTaskLoader<String> {

    private static final String LOG_TAG = MatchGETLoader.class.getSimpleName();
     ...
     */
    public MatchGETLoader(@NonNull Context context, String query) {
        super(context);
